# Inverting a matrix is usually a intensive task and requires heavy computations
# this could be overcome if we cache the objects which are not frequently changed 
# it can significantly reduce the cost of computation and hene below is the method
# where it uses two functions to calculate the inverse of the matrix using caching
